...
# `<hexlife-world>` — one binary world
...
- [`<hexlife-grid>`](./hexlife-grid.md) — more than a handful of these on one page.
- [Determinism](./determinism.md) — the pinned reference checksum for verifying a build.
