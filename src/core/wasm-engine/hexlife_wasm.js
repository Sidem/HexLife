...
export class World {
     ...
     * @param {Uint8Array} ruleset
     * @param {Uint8Array} state
     * @param {Uint8Array} next_state
     * @param {Uint8Array} rule_indices
     * @param {Uint32Array} rule_usage_counters
     */
    run_tick(ruleset, state, next_state, rule_indices, rule_usage_counters) {
        const ptr0 = passArray8ToWasm0(ruleset, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(state, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        var ptr2 = passArray8ToWasm0(next_state, wasm.__wbindgen_malloc);
        var len2 = WASM_VECTOR_LEN;
        var ptr3 = passArray8ToWasm0(rule_indices, wasm.__wbindgen_malloc);
        var len3 = WASM_VECTOR_LEN;
        var ptr4 = passArray32ToWasm0(rule_usage_counters, wasm.__wbindgen_malloc);
        var len4 = WASM_VECTOR_LEN;
        wasm.world_run_tick(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, next_state, ptr3, len3, rule_indices, ptr4, len4, rule_usage_counters);
    }
    /**
     ...
     * @returns {number}
     */
    calculate_checksum(arr) {
        const ptr0 = passArray8ToWasm0(arr, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.world_calculate_checksum(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
}
