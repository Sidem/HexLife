...
export const worldsolid_capTriangleCount: (a: number) => number;
export const worldsolid_zipPartCount: (a: number) => number;
export const worldsolid_zipPartName: (a: number, b: number) => [number, number, number, number];
export const worldsolid_zipPartOffset: (a: number, b: number) => [number, number, number];
export const worldsolid_zipPartLength: (a: number, b: number) => [number, number, number];
export const worldsolid_zipPartCrc32: (a: number, b: number) => [number, number, number];
