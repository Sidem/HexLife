...
function synthMetrics(hex, seed) {
    ...
    return {
        ...
        changeOrder: { mean: (u(6) - 0.25) * 0.6, last: 0 },
...
// the byte-identity oracle for deterministic populationSize:9 replays. Regenerate only when the search
// algorithm or score basis intentionally changes; #37 Stage 2 does so by adding change localization.
const GOLDEN_POPULATIONS = [
    ...
    [
        '0103050F113355FF0113074F153B75FE', '0103010F111355FF130B058F5133D5FF',
        '0103040B112151DF6983850F913355FF', '0103050F113355FF130B058F5133D5FE',
    ...
    [
        '0103040B112151DF6DA3CD1EB1B656E9', '0103050F113355FF6983850F913355FF',
        '0103050F113355FF7FABCD8FF1B3D5FE', '0103050F113355FF130B058F5133D5FF',
...
const GOLDEN_RESETSEEDS = [
    [123456, 123457, 123458, 123459, 123460, 123461, 123462, 123457, 133429, 133430, 133431, 133432, 133433, 133434, 133435, 133435, 143402, 143403, 143404, 143405, 143406, 143407, 143408],
    [123553, 123554, 123555, 123556, 123557, 123558, 123559, 123558, 133526, 133527, 133528, 133529, 133530, 133531, 133532, 133528, 143499, 143500, 143501, 143502, 143503, 143504, 143505, 143504],
    [123650, 123651, 123652, 123653, 123654, 123655, 123656, 123653, 133623, 133624, 133625, 133626, 133627, 133628, 133629, 133628, 143596, 143597, 143598, 143599, 143600, 143601, 143602, 143598],
    [123747, 123748, 123749, 123750, 123751, 123752, 123753, 123747, 133720, 133721, 133722, 133723, 133724, 133725, 133726, 133726, 143693, 143694, 143695, 143696, 143697, 143698, 143699, 143699],
    [123844, 123845, 123846, 123847, 123848, 123849, 123850, 123849, 133817, 133818, 133819, 133820, 133821, 133822, 133823, 133821, 143790, 143791, 143792, 143793, 143794, 143795, 143796, 143794],
    [123941, 123942, 123943, 123944, 123945, 123946, 123947, 123943, 133914, 133915, 133916, 133917, 133918, 133919, 133920, 133914, 143887, 143888, 143889, 143890, 143891, 143892, 143893],
    ...
    [124135, 124136, 124137, 124138, 124139, 124140, 124141, 124139, 134108, 134109, 134110, 134111, 134112, 134113, 134114, 134108, 144081, 144082, 144083, 144084, 144085, 144086, 144087],
    [124232, 124233, 124234, 124235, 124236, 124237, 124238, 124235, 134205, 134206, 134207, 134208, 134209, 134210, 134211, 134208, 144178, 144179, 144180, 144181, 144182, 144183, 144184, 144184],
];
...
describe('AutoExploreService determinism (golden characterization)', () => {
    ...
    it('replays the exact population, champion, and reset-seed trajectory for baseSeed 123456', async () => {
        ...
        if (process.env.DUMP_AUTO_GOLDEN) {
            console.log(JSON.stringify({
                populations: r.populations,
                champions: r.champions,
                resetSeeds: r.resetSeeds,
            }, null, 2));
        }
