...
const concepts = [
  ...
  },
  {
    ...
    parameters: [
      range('infection', 'Chance per infected neighbor', 1, 50, 12, '%', {scope: 'rule'}),
      range('infectiousTicks', 'Infectious duration', 1, 28, 6, ' ticks', {scope: 'rule'}),
      range('immunityTicks', 'Recovered immunity', 0, 360, 36, ' ticks', {scope: 'rule'}),
      range('coverage', 'Vaccine coverage', 0, 100, 20, '%'),
      range('efficacy', 'Vaccine efficacy', 1, 100, 85, '%', {scope: 'rule'}),
    ],
...
function renderShell(item) {
  ...
  root.innerHTML = `<div class="demo-shell concept-root" style="--demo-shell-width: 1460px">
    ...
    <footer class="demo-footer"><p>Demo ${String(index + 1).padStart(2, '0')} of ${concepts.length} · built with <strong>@hexlife/embed</strong> from npm.</p><nav><a href="./embed-demos.html">All demos</a><a href="https://github.com/Sidem/HexLife/blob/main/docs/embed/README.md" target="_blank" rel="noopener noreferrer">Package API</a><a href="./">HexLife Explorer</a></nav></footer></div>`;
}
