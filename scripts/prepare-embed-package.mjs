...
const copies = [
  ...
  ['src/embed/hcp.d.ts', 'dist/embed-package/src/embed/hcp.d.ts'],
  ['src/embed/hcp-element.d.ts', 'dist/embed-package/src/embed/hcp-element.d.ts'],
  ['src/core/HcpCodec.d.ts', 'dist/embed-package/src/core/HcpCodec.d.ts'],
